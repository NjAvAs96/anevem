...
const menu = {
	...
	openNav: document.querySelector('.js-menu-open'),
	closeNav: document.querySelector('.js-menu-close'),
	...
	linkClose: function() {
		...
		this.menuLinks.forEach(function(e) {
			e.addEventListener('click', function() {
				if(_this.navigation.classList.contains('nav--open')) {
					_this.navigation.classList.remove('nav--open');
				}
			});
		});
...
const country = {
	select: document.querySelector('.js-country-select'),
	...
	initializeSelectric: function() {
		$('.js-country-select').selectric({
	...
	initSlider: function() {
		this.slider.slick({
			...
			slidesToShow: 1,
  			slidesToScroll: 1,
			cssEase: 'linear',
			prevArrow: $('.js-branding-prev'),
			nextArrow: $('.js-branding-next'),
		});
	}
};
...
const services = {
	init: function() {
		this.accordion();
		this.imageChange();
		this.accordionScrollTo();
	},
	accordion: function() {
		$('.js-services-button').on('click', function() {
			$('.js-services-button').removeClass('active');
			$('.services__box').slideUp(300);
			...
			$('.js-services-button').on('click', function() {
				...
				setTimeout(function() {
					...
					$([document.documentElement, document.body]).animate({
						scrollTop: ( position - $('.header').outerHeight() - 50)
					}, 500);
				}, 300);
			});
		}
